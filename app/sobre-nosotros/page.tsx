        ...
        <div className="bg-white rounded-2xl border p-8 space-y-6">
          <div>
            ...
            <p className="text-gray-600 leading-relaxed">
              Somos <strong>{tenant.name}</strong>, una tienda dedicada a ofrecerte los mejores productos
              con la comodidad de comprar desde casa. Trabajamos cada día para brindarte una experiencia
              de compra segura, rápida y confiable.
            </p>
          </div>
