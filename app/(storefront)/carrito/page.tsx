        ...
        <div className="max-w-4xl mx-auto px-4 py-8">
          ...
          <div className="border rounded-2xl overflow-hidden mb-6">
            ...
            <div className="divide-y">
              {items.map((item) => (
                <div key={item.cartKey} className="p-4 flex flex-col sm:grid sm:grid-cols-[1fr_auto_auto] sm:items-center gap-3">
                  ...
                  <div className="flex items-center gap-2 sm:justify-center">
                    <button onClick={() => updateQty(item.cartKey, item.quantity - 1)} className="w-7 h-7 rounded-full border flex items-center justify-center hover:bg-gray-100">
                      <Minus size={12} />
                    </button>
                    ...
                    <button onClick={() => removeItem(item.cartKey)} className="ml-2 text-gray-400 hover:text-red-500 transition-colors">
                      <Trash2 size={16} />
                    </button>
                  </div>
          ...
          <div className="border rounded-2xl p-5 space-y-3">
            ...
            {couponCode && <p className="text-xs text-green-600 flex items-center gap-1"><CheckCircle2 size={12} />Cupón {couponCode} aplicado — -{formatPrice(discountAmount)}</p>}
