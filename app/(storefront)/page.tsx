...
import { Tag, Flame, ShoppingBag, Shirt, Tv, Smartphone, Home, Utensils, BookOpen, Dumbbell, Baby, Car, Heart, Laptop, Watch, Camera, Music, Gamepad2, Flower, Dog, Plane, Coffee, Package, Sparkles, Bike, Gem } from 'lucide-react'

const CAT_ICONS: Record<string, React.ElementType> = {
  ShoppingBag, Shirt, Tv, Smartphone, Laptop, Camera, Watch, Gem, Home, Utensils, Coffee, Baby, Dumbbell, Bike, Car, Plane, BookOpen, Music, Gamepad2, Dog, Flower, Heart, Sparkles, Package, Tag,
}
  ...
  return (
      <main className="">
              ...
              {categories.map((cat) => (
                ...
                >
                  {cat.imageUrl ? (
                    ...
                    <div className="w-12 h-12 rounded-full bg-gray-100 flex items-center justify-center"><Tag size={20} className="text-gray-400" /></div>
                  )}
        ...
        {offerProducts.length > 0 && (
          <section className="py-10 md:py-16 px-4 max-w-7xl mx-auto">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-xl sm:text-2xl font-bold flex items-center gap-2"><Flame size={22} className="text-orange-500" />Ofertas</h2>
