    ...
    <div>
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-0.5">Texto que aparece en la página de política de privacidad de la tienda</p>
        </div>
        <button
          onClick={handleSave}
          disabled={saving}
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
        ...
        <textarea
          ...
          rows={16}
          placeholder="En cumplimiento con la normativa vigente sobre protección de datos..."
        ...
        />
        <p className="text-xs text-gray-400 mt-2">Se mostrará en la página de política de privacidad de tu tienda.</p>
      </div>
    </div>
  )
}
